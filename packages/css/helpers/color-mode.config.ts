...
type Palette = "inherit" | "periwinkle" | "grey" | "coral" | "yellow";
...
const light = {
  ...
  ink: {
    ...
    code: { palette: "yellow", default: 650, inverted: 200 },
    link: {
      default: { palette: "inherit", default: 600, inverted: 100 },
  ...
  background: {
    code: { palette: "yellow", default: 100, inverted: 700 },
    control: {
...
const dark = {
  ...
  ink: {
    ...
    code: { palette: "yellow", default: 350, inverted: 650 },
    link: {
  ...
  background: {
    code: { palette: "yellow", default: 800, inverted: 250 },
    control: {
  ...
  // Shadows are only defined to keep the light/dark trees symmetric.
...
function generateLightDarkBlock(
...
function validatePaletteConsistency(): string[] {
  const errors: string[] = [];
...
function generate(): string {
  ...
  const defaultBlock = generateLightDarkBlock(light, dark, "default");
  const invertedBlock = generateLightDarkBlock(light, dark, "inverted");

  return `/* Generated by build.ts from color-mode.config.ts — do not edit */

/* ── Default ─────────────────────────────────────── */
:root,
color-mode {
${indent(defaultBlock, 2)}
}
...
const config: GeneratedConfig = {
  output: `${import.meta.dir}/color-mode.generated.css`,
  generate,
};
